...
module_boilerplate_ok('bin/about');
...
module_boilerplate_ok('bin/chop-line');
...
module_boilerplate_ok('bin/golp');
...
module_boilerplate_ok('bin/json-lines');
module_boilerplate_ok('bin/json-pretty');
module_boilerplate_ok('bin/json2yaml');
module_boilerplate_ok('bin/md');
module_boilerplate_ok('bin/module-dependencies');
module_boilerplate_ok('bin/myget');
module_boilerplate_ok('bin/nodedoc');
module_boilerplate_ok('bin/nowrap');
module_boilerplate_ok('bin/pactest');
...
module_boilerplate_ok('bin/sshfs-to');
